...
<body class="bg-gray-100 flex flex-col h-screen justify-center items-center"> 
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div class="mt-4 text-center">
            <a href="register.php" class="text-blue-500 hover:text-blue-700">Nog geen account? Registreer</a><br><br>
            <a href="forgot_password.php" class="text-blue-500 hover:text-blue-700">Wachtwoord vergeten?</a>
        </div>
    </div>
