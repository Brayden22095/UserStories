        ...
        <div class="max-w-md mx-auto bg-white rounded p-6 shadow-md">
            ...
            <form action="#" method="post">
                ...
                <div class="mt-6">
                    ...
                    <button type="button" onclick="window.location.href='index.php'" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400 cursor-pointer">Go back to front page</button>
                </div>
            </form>
            <?php
